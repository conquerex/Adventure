...
public class TabTest3 extends TabActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Intent int1 = new Intent(this, andexam.ver6.c11_widget.GramPrice.class);
		int1.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		tabHost.addTab(tabHost.newTabSpec("tag")
				.setIndicator("Price")
				.setContent(int1));

		Intent int2 = new Intent(this, andexam.ver6.c13_advwidget.StopWatch.class);
		int2.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
		tabHost.addTab(tabHost.newTabSpec("tab2")
				.setIndicator("StopWatch")
				.setContent(int2));
		
		Intent int3 = new Intent(this, andexam.ver6.c13_advwidget.SportsScore.class);
