...
public class EWProvider extends ContentProvider {
	static final Uri CONTENT_URI = Uri.parse("content://andexam.ver6.EnglishWord/word");
	...
	public String getType(Uri uri) {
		if (Matcher.match(uri) == ALLWORD) {
			return "vnd.EnglishWord.ver6.andexam.cursor.item/word";
		}
		if (Matcher.match(uri) == ONEWORD) {
			return "vnd.EnglishWord.ver6.andexam.cursor.dir/word";
		}
		return null;
	}
